...
public class DownloadListTestActivity  extends CCBaseRxAppCompactActivity implements View.OnClickListener, EasyPermissions.PermissionCallbacks {
    ...
    private List<CCDownloadTask> taskList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_download_list_test);
    ...
    private class RxNetDownloadCalback extends CCNetCallback {
        ...
        public <T> void onSuccess(Object reqTag, T response) {
            ...
            if (reqTag instanceof CCDownloadTask){
                ...
                taskList.get(index).setDownloadStatus(task.getDownloadStatus());
                taskList.get(index).setProgress(task.getProgress());
                taskList.get(index).setDownloadStatus(task.getDownloadStatus());
        ...
        public <T> void onProgress(Object tag, int progress, long netSpeed, long completedSize, long fileSize) {
            ...
            if (tag instanceof CCDownloadTask){

                CCDownloadTask task = (CCDownloadTask)tag;
    ...
    public void onItemBtnCallback(CCDownloadTask task){
        ...
        switch (task.getDownloadStatus()){
            case CCDownloadStatus.WAIT:
                ...
                CCDownloadManager.getInstance().pause(task);
                rvTask.getAdapter().notifyItemChanged(index);
                break;
            ...
            case CCDownloadStatus.PAUSED:
                ...
                CCDownloadManager.getInstance().resume(task);
                rvTask.getAdapter().notifyItemChanged(index);
                break;
    ...
    private class TaskRvAdapter extends RecyclerView.Adapter<TaskRvAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder holder = new MyViewHolder(LayoutInflater.from(DownloadListTestActivity.this).inflate(R.layout.item_task, parent, false));
            return holder;
        }
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            final CCDownloadTask task = taskList.get(position);
