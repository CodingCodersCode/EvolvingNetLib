...
/**
 * Created by CodingCodersCode on 2017/11/29.
 * <p>
 * Https工具类
 */
...
public class HttpsUtil {
    ...
    public static class SSLParams {
        ...
        public SSLParams(SSLSocketFactory sslSocketFactory, X509TrustManager x509TrustManager) {
    ...
    private static SSLParams getSSlSocketFactoryBase(X509TrustManager trustManager, InputStream bksFile, String password, InputStream... certificates) {
        ...
        try {
            ...
            CCLogUtil.printLog("e", HttpsUtil.class.getCanonicalName(), "发生异常", e);
